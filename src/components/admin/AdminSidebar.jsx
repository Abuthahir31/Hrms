    ...
    return (
        <>
            ...
            <aside className={`
                ...
                z-40 h-screen top-0 lg:top-20 lg:h-[calc(100vh-5rem)]
            `}>
                {/* Sidebar Content */}
                <div className="h-full flex flex-col">
                    {/* Header - Only on mobile */}
                    <div className="lg:hidden bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="border-t border-gray-200 p-3">
                        <Link
                            to="/user/home"
                            onClick={closeSidebar}
                            className="flex items-center gap-3 px-4 py-3 rounded-lg text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors font-medium"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                            </svg>
                            <span className="text-sm">Switch to User</span>
                        </Link>
                    </div> */}
                </div>
            </aside>
